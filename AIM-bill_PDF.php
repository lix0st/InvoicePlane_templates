...
<body>
    <header class="clearfix">
        <div id="company">
            <div>
                <b><?php _htmlsc($invoice->user_company); ?></b>
            </div>
            <div>
        ...
        <div class="invoice-details clearfix">
            <table>
                <tr>
                    <td style="font-weight: bold"><?php echo trans('invoice') . ':'; ?></td>
                    <td><?php echo $invoice->invoice_number; ?></td>
                </tr>
                <tr>
                    <td style="font-weight: bold"><?php echo trans('invoice_date') . ':'; ?></td>
                    <td><?php echo date_from_mysql($invoice->invoice_date_created, true); ?></td>
                </tr>
                <tr>
                    <td style="font-weight: bold"><?php echo trans('due_date') . ': '; ?></td>
                    <td><?php echo date_from_mysql($invoice->invoice_date_due, true); ?></td>
                </tr>
                <tr>
                    <td style="font-weight: bold"><?php echo trans('amount_due') . ': '; ?></td>
                    <td><?php echo format_currency($invoice->invoice_balance); ?></td>
                </tr>
                <?php if ($payment_method): ?>
                    <tr>
                        <td style="font-weight: bold"><?php echo trans('payment_method') . ': '; ?></td>
                    ...
                    <tr>
                        <td class="text-left">
                            ...
                            <?php if (!empty($item->item_description)) : ?>
                                ...
                                <small>
                                    &nbsp; &nbsp; 
                                    <?php echo str_replace("\n", "<br>&nbsp; &nbsp;", htmlsc($item->item_description)); ?>
                                </small>
                            <?php endif; ?>
                        </td>
                        <td class="text-right">
                            ...
                            <?php if ($item->item_product_unit) : ?>
                                <br>
                                <small style="left-padding:30px"><?php _htmlsc($item->item_product_unit); ?></small>
                            <?php endif; ?>
                        </td>
                        <td class="text-right">
    ...
    <?php if ($invoice->invoice_balance == 0) {
        echo '<watermarktext content="payé" alpha="0.2" />';
    }?>

    <footer>
        <span>Coordonnées bancaires:</span><br>
        <span>Alexandra Meyer - Chemin des Lilas 1 - 1700 Fribourg</span><br>
        <span>IBAN: CH38 0076 8300 1512 0850 8</span><br>
    </footer>
